...
const OtherBookDetail = () => {
  ...
  useEffect(() => {
    if (id) {
      ...
      fetch(`https://mezbaan-db.vercel.app/bookings/${type}/${id}`, {
        ...
        .catch((error) =>
          console.error("Error fetching other service data:", error)
        );
    }
  }, [id, type, refreshKey]);
  ...
  const { customer, otherService,booking, otherServiceBooking } = otherData;
      ...
      <div className="card shadow-lg border-0" style={{ backgroundColor: "#f9f9f9" }}>
        ...
        <div className="card-body">
          ...
          <div className="row mb-3">
            ...
            <div className="col-md-6">
              <strong>Service Count:</strong> {otherServiceBooking.serviceCount}
            </div>
          </div>
          <hr />
...
export default OtherBookDetail;
