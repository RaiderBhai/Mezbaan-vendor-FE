...
const VenueBookDetail = () => {
  const { state } = useLocation();
  const { id, type } = state || {};
  const [venueData, setVenueData] = useState(null);
  const [refreshKey, setRefreshKey] = useState(0);

  // Fetch venue booking data
  useEffect(() => {
    if (id) {
  ...
  const { customer, venue, booking } = venueData;
      ...
      <div className="card shadow-lg border-0" style={{ backgroundColor: "#f9f9f9" }}>
        ...
        <div className="card-body">
          ...
          <div className="row mb-3">
            ...
            <div className="col-md-6">
              <strong>Bill:</strong> Rs. {booking.bill}
            </div>
          </div>
          <div className="row mb-3">
            <div className="col-md-6">
              <strong>Manager name:</strong> {venue.managerName}
            </div>
            <div className="col-md-6">
              <strong>Manager contact:</strong> {venue.managerNumber}
            </div>
          </div>
          <div className="row mb-3">
            <div className="col-md-6">
...
export default VenueBookDetail;
